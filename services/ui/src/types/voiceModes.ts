...
export const AVAILABLE_TOOLS = {
  ...
  Fabrication: [
    { id: 'segment_mesh', name: 'Segment Mesh', description: 'Segment large models into printable parts', paid: false },
    { id: 'check_segmentation', name: 'Check Segmentation', description: 'Check if model needs segmentation', paid: false },
    { id: 'list_printers', name: 'List Printers', description: 'List available printers with status', paid: false },
    { id: 'slice_model', name: 'Slice Model', description: 'Convert 3D model to G-code', paid: false },
    { id: 'check_slicing_status', name: 'Check Slicing', description: 'Check slicing job progress', paid: false },
    { id: 'send_to_printer', name: 'Send to Printer', description: 'Upload G-code and start print', paid: false },
  ],
  Discovery: [
...
export const VOICE_MODES: VoiceMode[] = [
  ...
  },
  {
    ...
    name: 'Maker',
    icon: '🔧',
    description: 'Full fabrication workflow: generate, segment, slice, print',
    allowPaid: true,
    preferLocal: false,
    enabledTools: [
      'generate_cad_model',
