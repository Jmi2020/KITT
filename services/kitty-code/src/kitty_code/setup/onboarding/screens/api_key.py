...
from kitty_code.core.paths.global_paths import GLOBAL_ENV_FILE
from kitty_code.setup.onboarding.base import OnboardingScreen

PROVIDER_HELP = {
    "mistral": ("https://console.mistral.ai/codestral/vibe", "Mistral AI Studio")
}
CONFIG_DOCS_URL = (
    "file://~/.kitty-code/config.toml"  # Local config - airgap compliant
)
