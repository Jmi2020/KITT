...
from kitty_code import __version__ as CORE_VERSION
from kitty_code.cli.clipboard import copy_selection_to_clipboard
...
from kitty_code.core.agent import Agent
from kitty_code.core.autocompletion.path_prompt_adapter import render_path_prompt
from kitty_code.core.config import VibeConfig
from kitty_code.core.modes import AgentMode, next_mode
from kitty_code.core.paths.config_paths import HISTORY_FILE
from kitty_code.core.tools.base import BaseToolConfig, ToolPermission
from kitty_code.core.types import ApprovalResponse, LLMMessage, Role
from kitty_code.core.utils import (
    CancellationReason,
...
def _print_session_resume_message(session_id: str | None) -> None:
    ...
    print()
    print("To continue this session, run: kitty-code --continue")
    print(f"Or: kitty-code --resume {session_id}")
...
def run_textual_ui(
    ...
    update_notifier = PyPIVersionUpdateGateway(project_name="kitty-code")
