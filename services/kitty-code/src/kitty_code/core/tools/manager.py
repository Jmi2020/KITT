...
from kitty_code.core.paths.config_paths import resolve_local_tools_dir
from kitty_code.core.paths.global_paths import DEFAULT_TOOL_DIR, GLOBAL_TOOLS_DIR
from kitty_code.core.tools.base import BaseTool, BaseToolConfig
from kitty_code.core.tools.mcp import (
    RemoteTool,
