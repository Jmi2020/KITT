...
- **Phase 0 — Foundations (Week 1)**: Compose containers (gateway, voice service placeholder, Open WebUI, API services, MQTT, vector DB, Grafana), set up host-native Ollama/MLX + Whisper/Piper, connect Tailscale, bootstrap CI/CD.
